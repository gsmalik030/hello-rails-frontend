...
**hello-rails-frontend** is front end of greeting app.

**hello-rails-backend** Link
https://github.com/gsmalik030/hello-rails-backend
...
- Show Different greeting everytime you run the app.
...
```sh
  cd math-magicians
  git clone https://github.com/gsmalik030/hello-rails-frontend
```
...
Feel free to check the [issues page](https://github.com/gsmalik030/hello-rails-frontend/issues).
